...
LANG = {
    "en": {
        ...
        "a_cost": "FBT Seller-side Cost",
        "b_cost": "Current Solution Cost",
        "c_savings": "Seller-side Savings",
        ...
        "chart1": "Cost Curve",
        "chart2": "Total Cost Comparison",
        "chart3": "Cost Breakdown",
    ...
    "de": {
        "title": "FBT Bestands- und Fulfillment-Nutzen-Simulator",
        "subtitle": "Vergleich von FBT mit dem aktuellen Fulfillment-Modell aus Kosten- und Gewinnsicht.",
        "basic_inputs": "1. Basisdaten",
        "fbt_inputs": "2. FBT-Eingaben",
        "current_inputs": "3. Aktuelles Modell",
        "business_inputs": "4. Business-Eingaben",
        "report_inputs": "Berichtsangaben",
        "calculate": "Berechnen",
        "reset": "Zurücksetzen",
        ...
        "avg_items_per_order": "Ø Artikel pro Bestellung",
        "avg_volume_m3_per_item": "Ø Volumen pro Artikel (m³)",
        "avg_storage_days": "Ø Lagertage",
        "inventory_coverage_days": "Bestandsreichweite in Tagen",
        "return_rate": "Retourenquote",
        "avg_order_value": "Warenkorbwert (€)",

        "share_ge_20": "Anteil Bestellungen >= €20",
        "share_lt_20": "Anteil Bestellungen < €20",

        "size_xs_share": "XS-Anteil",
        "size_s_share": "S-Anteil",
        "size_m_share": "M-Anteil",
        "size_l_share": "L-Anteil",

        "fbt_storage_cost": "FBT Lagerkosten / m³ / Tag",
        "buyer_shipping_domestic": "Kundenversand (Inland)",
        "buyer_shipping_intra": "Kundenversand (Intra-EU)",

        "current_storage_cost": "Aktuelle Lagerkosten / m³ / Tag",
        "current_fulfillment_per_order": "Aktuelle Fulfillment-Kosten / Bestellung",
        "current_return_processing": "Aktuelle Retourenkosten / Bestellung",
        "current_inventory_handling_monthly": "Aktuelle Lagerabwicklung pro Monat",
        "current_stock_loss_monthly": "Aktueller Bestandsverlust / Schäden pro Monat",
        "current_manpower_monthly": "Aktuelle Personalkosten Lager pro Monat",
        "current_other_fixed_monthly": "Sonstige Fixkosten pro Monat",

        "warehouse_country": "Lagerland",
        "domestic_share": "Anteil Inland",
        "intra_eu_share": "Anteil Intra-EU",

        "decision": "Empfehlung",
        "recommend_fbt": "✅ FBT empfohlen",
        "not_recommend_fbt": "❌ Aktuell nicht empfohlen",

        "a_cost": "FBT-Kosten Verkäuferseite",
        "b_cost": "Kosten aktuelles Modell",
        "c_savings": "Einsparung Verkäuferseite",
        "savings_rate": "Einsparungsquote",
        "per_order_saving": "Einsparung pro Bestellung",
        "free_shipping_orders": "Versandkostenfreie Bestellungen (>=€20)",
        "buyer_shipping_saved": "Gesparter Versandwert auf Käuferseite",

        "monthly_revenue": "Monatsumsatz",
        "fbt_profit": "FBT Gewinn",
        "current_profit": "Gewinn aktuelles Modell",
        "profit_uplift": "Gewinnsteigerung (nur Kostensenkung)",

        "fbt_breakdown": "FBT-Kostenstruktur",
        "current_breakdown": "Kostenstruktur aktuelles Modell",

        "chart1": "Kostenkurve",
        "chart2": "Gesamtkostenvergleich",
        "chart3": "Kostenstruktur",

        "line_fbt": "FBT",
        "line_current": "Aktuell",
        "line_savings": "Einsparung",

        "x_orders": "Monatliche Bestellungen",
        "y_eur": "EUR",

        "storage": "Lagerung",
        "fulfillment": "Fulfillment",
        "returns": "Retouren",
        "handling": "Lagerabwicklung",
        "stock_loss": "Bestandsverlust / Schäden",
        "manpower": "Personal",
        "other_fixed": "Sonstige Fixkosten",

        "sales_insight": "Vertriebs-Insight",
        "executive_summary": "Management Summary",
        "annual_impact": "Jährlicher Effekt",
        "breakeven_found": "Break-even bei ca. {orders} Bestellungen pro Monat",
        "breakeven_not_found": "Im aktuellen Bestellbereich wurde kein Break-even gefunden",

        "section_results": "Ergebnisse",
        "section_profit": "Gewinnvergleich",
        "section_breakdown": "Kostenaufschlüsselung",
        "section_assumptions": "Normalisierte Anteile",
        "download_csv": "Ergebnisse als CSV herunterladen",
        "download_pdf": "PDF-Bericht herunterladen",

        "note_input": "Hinweis",
        "note_input_text": "Die Anteile müssen nicht exakt 1,0 ergeben. Das Tool normalisiert sie automatisch.",
        "profit_note": "Die Gewinnsteigerung berücksichtigt nur Kostensenkung. Es wird kein GMV- oder Conversion-Uplift angenommen.",

        "placeholder": "Bitte oben die Eingaben ausfüllen und auf Berechnen klicken.",
        "domestic_norm": "Anteil Inland (normalisiert)",
        "intra_norm": "Anteil Intra-EU (normalisiert)",
        "ge20_norm": "Anteil >= €20 (normalisiert)",
        "lt20_norm": "Anteil < €20 (normalisiert)",
        "xs_norm": "XS-Anteil (normalisiert)",
        "s_norm": "S-Anteil (normalisiert)",
        "m_norm": "M-Anteil (normalisiert)",
        "l_norm": "L-Anteil (normalisiert)",

        "pdf_title": "FBT Nutzen-Simulationsbericht",
        "pdf_subtitle": "Erstellt mit dem Streamlit-Simulator",
        "pdf_inputs": "Eingabeübersicht",
        "pdf_outputs": "Ergebnisübersicht",
        "pdf_notes": "Hinweise",
        "pdf_cover_for": "Erstellt für",
        "pdf_cover_date": "Berichtsdatum",
        "pdf_conclusion": "Fazit",
        "pdf_exec_summary": "Management Summary",
        "default_client_name": "Kunde",
    },
    "zh": {
        "title": "FBT 库存与履约收益模拟器",
        "subtitle": "从成本和利润两个视角，对比 FBT 与当前履约方案。",
        "basic_inputs": "1. 基础输入",
        "fbt_inputs": "2. FBT 输入",
        "current_inputs": "3. 当前方案输入",
...
👉 {lang['profit_note']}
    ...
    input_summary = [
        ...
        f"{lang['current_inventory_handling_monthly']}: {format_eur(current_inventory_handling_monthly)}",
        f"{lang['current_stock_loss_monthly']}: {format_eur(current_stock_loss_monthly)}",
        f"{lang['current_manpower_monthly']}: {format_eur(current_manpower_monthly)}",
        f"{lang['current_other_fixed_monthly']}: {format_eur(current_other_fixed_monthly)}",
    ]
